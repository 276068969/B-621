...
echo '}';
echo '';
echo 'function updateReadingProgressAll() {';
echo '  var progressBar = document.getElementById("readingProgressBar");';
echo '  var progressPercent = document.getElementById("readingPercent");';
echo '  var toolbar = document.getElementById("readingToolbar");';
echo '  var postContent = document.getElementById("post-content");';
...
echo '  }';
echo '}';
echo 'window.removeEventListener("scroll", updateReadingProgress);';
echo 'window.addEventListener("scroll", updateReadingProgressAll);';
echo 'updateReadingProgressAll();';
echo '';
...
echo '    var isToolbarBtn = e.target.closest(".comment-tool-btn");';
echo '    var isAnchor = e.target.closest(".comment-anchor");';
echo '    if (commentItem && !isToolbarBtn && !isAnchor) {';
