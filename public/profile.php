...
$historyCount = get_user_reading_history_count($pdo, $userId);
...
echo '</div>';
echo '<div class="col-6 col-sm-3">';
echo '<a href="/history.php" class="text-decoration-none">';
...
echo '<div class="stat-number" style="color:#3b82f6;">' . e((string)$historyCount) . '</div>';
echo '<div class="stat-label">📖 最近浏览</div>';
echo '</div>';
echo '</a>';
echo '</div>';
echo '<div class="col-6 col-sm-3">';
